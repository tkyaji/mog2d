...
public class MogJniBridge {
    ...
    public static native void onSurfaceChanged(int w,int h, int vw, int vh, float scaleFactor);
    public static native void onDrawFrame();
    public static native int getDefaultFps();

    public static native void onCreate(Activity activity, AssetManager assetManager);
