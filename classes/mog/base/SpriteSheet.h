...
namespace mog {
    ...
    public:
        static shared_ptr<SpriteSheet> create(string filename, unsigned int frameCount, const Size &frameSize, int margin = 0, Point startPosition = Point::zero);
    ...
    protected:
        ...
        void init(string filename, unsigned int frameCount, const Size &frameSize, int margin = 0, Point startPosition = Point::zero);
